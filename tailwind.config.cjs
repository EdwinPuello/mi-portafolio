...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-mobile':
          'linear-gradient(137deg, rgba(244, 244, 246, 0.8) 60%, rgb(201 201 201 / 90%) 60%)',
        tech: "linear-gradient(165deg, rgba(20,20,20,0.8) 100%, rgba(109,109,116,0.8) 100%), url('/src/assets/backgrounds/ventanaAlMundo.jpg')",
      },
      fontFamily: {
        arenq: ['Arenq'],
        beckman: ['Beckman'],
  ...
  plugins: [],
  base:'https://EdwinPuello.github.io/mi-portafolio'
};
